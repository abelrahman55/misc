                ...
                <ul class="nav-links flex-column nav position-relative ">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('appointment_chat.index') }}" class="nav-link d-flex align-items-center gap-3">
                            <div class="box-icon">
                                <i class="bi bi-chat-dots-fill" style="font-size: 16px; color: #347FC2;"></i>
                            </div>
                            Messages
                        </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a href="{{ route('patient_profile', auth()->guard('web')->user()->id) }}" class="nav-link d-flex align-items-center gap-3">
                            <div class="box-icon">
