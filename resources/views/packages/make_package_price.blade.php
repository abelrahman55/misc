...
<div class="container-fluid d-flex main-content">
    ...
    <main class="col dashboard-content p-4">
        ...
        <h3 class="mb-4">تقديم عرض سعر </h3>
        ...
        @foreach($conversations as $booking)
            <div class="price-offer">
                ...
                <div class="d-flex align-items-center mb-3">
                    <img src="{{ $booking->provider?->prof_img_url ?? asset('images/default.png') }}"
                         alt="Provider"
            ...
            <form action="{{ route('package_make_offer') }}" method="POST" class="mt-3">
    @csrf
