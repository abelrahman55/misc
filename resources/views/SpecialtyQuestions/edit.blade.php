...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-10 p-4 pb-0" style="font-family: Poppins, sans-serif;">
            <h1 class="header-page mb-4">Edit Specialty Question</h1>
            <div class="row">
                <div class="col px-3">
                    <div class="card p-4">
                        <div class="card-body">
                            <form action="{{ route('specialty-questions.update', $question->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="tab-pane fade show active" id="lang-ar" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="question[ar]" class="form-control"
                                                value="{{ old('question.ar', $question->question['ar'] ?? '') }}" placeholder="أدخل السؤال" required>
                                            @error('question.ar')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="answer[ar]" class="form-control" placeholder="أدخل الإجابة" required>{{ old('answer.ar', $question->answer['ar'] ?? '') }}</textarea>
                                            @error('answer.ar')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-en" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="question[en]" class="form-control"
                                                value="{{ old('question.en', $question->question['en'] ?? '') }}" placeholder="Enter the question" required>
                                            @error('question.en')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="answer[en]" class="form-control" placeholder="Enter the answer" required>{{ old('answer.en', $question->answer['en'] ?? '') }}</textarea>
                                            @error('answer.en')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-fr" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="question[fr]" class="form-control"
                                                value="{{ old('question.fr', $question->question['fr'] ?? '') }}" placeholder="Entrez le question">
                                            @error('question.fr')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="answer[fr]" class="form-control" placeholder="Entrez la answer">{{ old('answer.fr', $question->answer['fr'] ?? '') }}</textarea>
                                            @error('answer.fr')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-gr" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="question[gr]" class="form-control"
                                                value="{{ old('question.gr', $question->question['gr'] ?? '') }}" placeholder="Geben Sie den Frage ein">
                                            @error('question.gr')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="answer[gr]" class="form-control" placeholder="Geben Sie die Antwort ein">{{ old('answer.gr', $question->answer['gr'] ?? '') }}</textarea>
                                            @error('answer.gr')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
