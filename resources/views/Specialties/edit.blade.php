...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-10 p-4 pb-0" style="font-family: Poppins, sans-serif;">
            <h1 class="header-page mb-4">Edit Specialty</h1>
            <div class="row">
                <div class="col px-3">
                    <div class="card p-4">
                        <div class="card-body">
                            <form action="{{ route('specialties.update', $specialty->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-pane fade show active" id="lang-ar" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[ar]" class="form-control"
                                                value="{{ old('title.ar', $specialty->title['ar'] ?? '') }}" placeholder="أدخل اسم التخصص" required>
                                            @error('title.ar')
                                    ...
                                    <div class="tab-pane fade" id="lang-en" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[en]" class="form-control"
                                                value="{{ old('title.en', $specialty->title['en'] ?? '') }}" placeholder="Enter specialty name" required>
                                            @error('title.en')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-fr" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[fr]" class="form-control"
                                                value="{{ old('title.fr', $specialty->title['fr'] ?? '') }}" placeholder="Entrez le nom de la spécialité">
                                            @error('title.fr')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-gr" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[gr]" class="form-control"
                                                value="{{ old('title.gr', $specialty->title['gr'] ?? '') }}" placeholder="Geben Sie den Fachgebietsnamen ein">
                                            @error('title.gr')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-control">
                                        <option value="1" {{ $specialty->status == 1 ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{ $specialty->status == 0 ? 'selected' : '' }}>Inactive</option>
                                    </select>
                                </div>
