...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-10 p-4 pb-0" style="font-family: Poppins, sans-serif;">
            <h1 class="header-page mb-4">Add New Package Nursing</h1>
            <div class="row">
                <div class="col px-3">
                    <div class="card p-4 shadow-sm border-0">
                        <div class="card-body">
                            <form action="{{ route('packages_nursing.store') }}" method="POST">
                                @csrf
                                ...
                                {{--  <div class="mb-3 mt-4">
                                    ...
                                    <input type="number" name="price" class="form-control" step="0.01" placeholder="Enter price" value="{{ old('price') }}" >
                                    @error('price')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>  --}}
                                ...
                                <button type="submit" class="btn btn-purple text-white px-4 mt-3">Save Package</button>
                            </form>
                        </div>
                    </div>
                </div>
