...
<div class="msg-wrapper {{ (($message?->user_id == auth()->id())||auth()->user()->role=='admin') ? 'sent-box' : 'received-box' }}">
    <div class="msg {{ (($message?->user_id == auth()->id())||auth()->user()->role=='admin') ? 'sent' : 'received' }}">
