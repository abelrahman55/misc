...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-10 p-4 pb-0" style="font-family: Poppins, sans-serif;">
            <h1 class="header-page mb-4">Add New Treatment Service</h1>
            <div class="row">
                <div class="col px-3">
                    <div class="card p-4">
                        <div class="card-body">
                            <form action="{{ route('treatment-services.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="specialty_id" class="form-control" required>
                                        ...
                                        <option value="{{ $specialty->id }}">{{ $specialty->title['en'] ?? $specialty->title['ar'] ?? $specialty->id }}</option>
                                        @endforeach
                                    </select>
                                    @error('specialty_id')
                                    ...
                                    <div class="tab-pane fade show active" id="lang-ar" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[ar]" class="form-control"
                                                value="{{ old('title.ar') }}" placeholder="أدخل اسم الخدمة" required>
                                            @error('title.ar')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-en" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[en]" class="form-control"
                                                value="{{ old('title.en') }}" placeholder="Enter service name" required>
                                            @error('title.en')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-fr" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[fr]" class="form-control"
                                                value="{{ old('title.fr') }}" placeholder="Entrez le nom de la service">
                                            @error('title.fr')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-gr" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[gr]" class="form-control"
                                                value="{{ old('title.gr') }}" placeholder="Geben Sie den Servicenamen ein">
                                            @error('title.gr')
                                            <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
