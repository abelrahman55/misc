                                    ...
                                    <div class="tab-pane fade show active" id="lang-ar" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="question[ar]" class="form-control"
                                                value="{{ old('question.ar', $faq->question['ar'] ?? '') }}" placeholder="أدخل العنوان" required>
                                            @error('question.ar')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="answer[ar]" class="form-control" placeholder="أدخل الوصف" required>{{ old('answer.ar', $faq->answer['ar'] ?? '') }}</textarea>
                                            @error('answer.ar')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-en" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="question[en]" class="form-control"
                                                value="{{ old('question.en', $faq->question['en'] ?? '') }}" placeholder="Enter the question" required>
                                            @error('question.en')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="answer[en]" class="form-control" placeholder="Enter the answer" required>{{ old('answer.en', $faq->answer['en'] ?? '') }}</textarea>
                                            @error('answer.en')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-fr" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="question[fr]" class="form-control"
                                                value="{{ old('question.fr', $faq->question['fr'] ?? '') }}" placeholder="Entrez le titre">
                                            @error('question.fr')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="answer[fr]" class="form-control" placeholder="Entrez la answer">{{ old('answer.fr', $faq->answer['fr'] ?? '') }}</textarea>
                                            @error('answer.fr')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="lang-gr" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="question[gr]" class="form-control"
                                                value="{{ old('question.gr', $faq->question['gr'] ?? '') }}" placeholder="Geben Sie den Titel ein">
                                            @error('question.gr')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="answer[gr]" class="form-control" placeholder="Geben Sie die Beschreibung ein">{{ old('answer.gr', $faq->answer['gr'] ?? '') }}</textarea>
                                            @error('answer.gr')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
