            ...
            @endcan
                ...
                @endcan
                 ...
                 @can('package-options')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('package-options.index') }}" class="nav-link d-flex align-items-center gap-3">
                            <div class="box-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-people-fill" viewBox="0 0 16 16">
                                <path
                ...
                @can('package-options-nursing')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('package-options-nursing.index') }}" class="nav-link d-flex align-items-center gap-3">
                            <div class="box-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-people-fill" viewBox="0 0 16 16">
                                <path
                ...
                @can('package-options-hospital')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('package-options-hospital.index') }}" class="nav-link d-flex align-items-center gap-3">
                            <div class="box-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-people-fill" viewBox="0 0 16 16">
                                <path
                ...
                @endcan
                 ...
                 @can('packages_hospital')
                    ...
                    <li class="nav-item">
                        <a href="{{ route('packages_hospital.index') }}" class="nav-link d-flex align-items-center gap-3">
                            <div class="box-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                class="bi bi-people-fill" viewBox="0 0 16 16">
                                <path
