                            ...
                            <form action="{{ route('blogs.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-pane fade show active" id="lang-ar" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[ar]" class="form-control"
                                                value="{{ old('title.ar', $blog->title['ar'] ?? '') }}" placeholder="أدخل العنوان" required>
                                            @error('title.ar')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description[ar]" class="form-control" placeholder="أدخل الوصف" required>{{ old('description.ar', $blog->description['ar'] ?? '') }}</textarea>
                                    ...
                                    <div class="tab-pane fade" id="lang-en" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[en]" class="form-control"
                                                value="{{ old('title.en', $blog->title['en'] ?? '') }}" placeholder="Enter the title" required>
                                            @error('title.en')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description[en]" class="form-control" placeholder="Enter the description" required>{{ old('description.en', $blog->description['en'] ?? '') }}</textarea>
                                    ...
                                    <div class="tab-pane fade" id="lang-fr" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[fr]" class="form-control"
                                                value="{{ old('title.fr', $blog->title['fr'] ?? '') }}" placeholder="Entrez le titre">
                                            @error('title.fr')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description[fr]" class="form-control" placeholder="Entrez la description">{{ old('description.fr', $blog->description['fr'] ?? '') }}</textarea>
                                    ...
                                    <div class="tab-pane fade" id="lang-gr" role="tabpanel">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title[gr]" class="form-control"
                                                value="{{ old('title.gr', $blog->title['gr'] ?? '') }}" placeholder="Geben Sie den Titel ein">
                                            @error('title.gr')
                                                <small class="text-danger">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description[gr]" class="form-control" placeholder="Geben Sie die Beschreibung ein">{{ old('description.gr', $blog->description['gr'] ?? '') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-control" required>
                                        <option value="1"
                                            {{ old('status', $blog->status ?? "1") == "1" ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="0"
                                            {{ old('status', $blog->status ?? "0") == "0" ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
                                    @error('status')
                                        <small class="text-danger">{{ $message }}</small>
