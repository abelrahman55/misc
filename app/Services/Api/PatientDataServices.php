...
class PatientDataServices
{
    public static function CompleteData($data)
    {
        ...
        $userFields = [
            'gender', 'home_number', 'street_name', 'town_id', 'country_id', 'military_status', 'occupation', 'language',
...
if(isset($data['current_treatment'])){
