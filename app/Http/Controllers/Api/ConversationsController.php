...
class ConversationsController extends Controller
{
    ...
    public function send_message(SendMessageRequest $request)
    {
        ...
        if ($message) {
            ...
            Http::withoutVerifying()
                ->timeout(15)
                ->put("https://misc-56c92-default-rtdb.firebaseio.com/conversations/{$data['conversation_id']}.json", $firebaseData);
    ...
    public function messages()
    {
        ...
        // return $user;
        $conversations = Conversation::with(['messages', 'receiver', 'sender'])
    ...
    public function conv_messages(Request $request)
    {
        ...
        $conversation = Conversation::with('messages.user', 'sender', 'receiver')->findOrFail($id);
